  ...
  translations: {
    th: {
      ...
      nav: {
        ...
        logout: 'ออกจากระบบ',
        waterEntry: 'บันทึกค่าน้ำ',
        electricEntry: 'บันทึกค่าไฟ',
        monthlyDisbursement: 'เบิกจ่ายประจำเดือน',
        slipReview: 'ตรวจสลิป',
        profileSettings: 'ตั้งค่าข้อมูลส่วนตัว',
        adminSettings: 'ตั้งค่าแอดมิน',
        rulesForms: 'ระเบียบ / แบบฟอร์ม',
        manual: 'คู่มือ',
        login: 'เข้าสู่ระบบ',
        register: 'ลงทะเบียน'
      },
    ...
    en: {
      ...
      nav: {
        ...
        electricEntry: 'Electric Entry',
        monthlyDisbursement: 'Monthly Disbursement',
        slipReview: 'Slip Review',
        profileSettings: 'Profile Settings',
        adminSettings: 'Admin Settings',
        rulesForms: 'Rules & Forms',
        manual: 'Manual',
        login: 'Login',
        register: 'Register'
      },
